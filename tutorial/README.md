...
Επιλέγετε mm για τα Πολυμέσα και πατάτε το κουμπι clone για να κατέβει το αντίστοιχο repository στον υπολογιστή σας. Επιλέγετε ένα φάκελο στον οποίο θα αποθηκευτεί το repository.
